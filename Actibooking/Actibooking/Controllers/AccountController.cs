...
namespace Actibooking.Controllers
{
    ...
    public class AccountController :ControllerBase
    {
        ...
        public IActionResult Authenticate([FromBody] AuthenticateRequest data)
        {
            ...
            settings.Audience = new List<string>() { "337470745858-36e0ar5ddn0csbinl1ore0qor37t6imn.apps.googleusercontent.com" };

            GoogleJsonWebSignature.Payload payload = GoogleJsonWebSignature.ValidateAsync(data.IdToken, settings).Result;
            return Ok(new { Token = _authManager.CreateUserAuthToken(payload.Email) });
        }
    }
}
