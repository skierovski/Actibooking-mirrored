    ...
    <>
      ...
      <div className={styles.organizations}>
            <div className = {styles.pageNumber}>
              <BsFillArrowLeftCircleFill className = {styles.arrow} size={20} onClick={prevPage}/> {page} <BsFillArrowRightCircleFill className = {styles.arrow} size={20} onClick={nextPage}/>
            </div>
